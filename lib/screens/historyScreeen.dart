...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  child: Padding(
    ...
    child: Container(
      ...
      child:ListTile(title: Text("disease name ",style:TextStyle(color:white,fontSize:22),),subtitle: Text("Date:22/7/21",style:TextStyle(color:white,fontSize:15)),trailing: Icon(Icons.check_box_outlined,color: Colors.red,size: 40,),)
